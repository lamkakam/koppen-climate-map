...
- add index.ts files for each directory to export all components in that directory for easier imports.

## Styling
- Use Tailwind CSS. Define and reuse theme variables in `src/shared/styles/theme.ts` for unified look and feel.
