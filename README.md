...
The first deck.gl map iteration reads browser image tiles from:
...
If the tiles move, update `KOPPEN_TILE_URL` in `src/features/climate-map/layers/KoppenTileLayer.ts`.
