      ...
      <div className="max-h-[calc(50vh-3rem)] overflow-hidden rounded-t-lg lg:max-h-[calc(100vh-2rem)] lg:rounded-lg">
        ...
        {isExpanded ? (
          <div
            ...
            className="grid max-h-[calc(50vh-11.5rem)] grid-cols-[repeat(auto-fit,minmax(4.75rem,1fr))] gap-1 overflow-y-auto px-2 py-1.5 lg:block lg:max-h-[calc(100vh-22rem)] lg:py-2"
